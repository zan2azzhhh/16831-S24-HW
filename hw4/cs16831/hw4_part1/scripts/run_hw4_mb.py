...
from cs16831.hw4_part1.infrastructure.rl_trainer import RL_Trainer
...
def main():
    ...
    parser.add_argument('--env_name', type=str) #reacher-hw4_part1-v0, ant-hw4_part1-v0, cheetah-hw4_part1-v0, obstacles-hw4_part1-v0
